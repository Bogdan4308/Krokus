...
local fontupdate = renderCreateFont("Calibri", 15, 5)
local allSum = 0
...
local StepNot = 0
local Sum = 0
local active, get, notontimer1, notontimer2, paytax,check_tax, take_salary, update_status = false, false,false,false,false,false,false,false
...
function sampev.onServerMessage(color, text)
	...
	if nick and color == -1178486529 then
	    lua_thread.create(function()
		wait(100)
